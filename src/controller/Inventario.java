...
public class Inventario extends Application {
    ...
    private ObservableList<Producto> productoss = FXCollections.observableArrayList();
    ...
    public Inventario() {
        ...
        productoss.add(new Producto("NA01013", "Gorro", "Deportes Acuáticos", 341, 6.59, crearImagen("gorroPiscina"), "Gorro de tamaño medio para competición", "../img/products/gorroPiscina.jpg"));
        productoss.add(new Producto("NA01014", "Bañador", "Deportes Acuáticos", 984, 8.99, crearImagen("bañador"), "Bañador para natación talla M. Muy cómodo", "../img/products/bañador.jpg"));
        productoss.add(new Producto("NA01014", "Manoplas", "Deportes Acuáticos", 567, 5.59, crearImagen("manoplasNatacion"), "Guantes para impulsarse a gran velocidad en el agua", "../img/products/manoplasNatacion.jpg"));

        // futbol
        productoss.add(new Producto("FU02011", "Botas de fútbol", "Fútbol", 345, 39.99, crearImagen("botasFutbol"), "Botas profesionales baratas y de gran calidad", "../img/products/botasFutbol.jpg"));
        productoss.add(new Producto("FU02012", "Pantalones cortos", "Fútbol", 875, 10.59, crearImagen("pantalonesCortosFutbol"), "Pantalones tamaño M para fútbol. Calidad algodon 100%", "../img/products/pantalonesCortosFutbol.jpg"));
        productoss.add(new Producto("FU02013", "Camiseta", "Fútbol", 156, 21.99, crearImagen("camisetaFutbol"), "Camiseta técnica", "../img/products/camisetaFutbol.jpg"));
        productoss.add(new Producto("FU02014", "Protectores", "Fútbol", 98, 39.99, crearImagen("protectoresFutbol"), "Tobilleras protectoras en caso de accidentes en el terreno de juego", "../img/products/protectoresFutbol.jpg"));
        productoss.add(new Producto("FU02015", "Medias", "Fútbol", 443, 13.29, crearImagen("mediasFutbol"), "Medias talla L enfocadas al fútbol", "../img/products/mediasFutbol.jpg"));

        // tenis
        productoss.add(new Producto("TE03011", "Raqueta", "Tenis", 665, 59.99, crearImagen("raquetaTenis"), "Raqueta réplica de Rafael Nadal. Muy buen rendimiento y cordaje fuerte", "../img/products/raquetaTenis.jpg"));
        productoss.add(new Producto("TE03012", "Cordaje", "Tenis", 872, 19.99, crearImagen("cordajeRaqueta"), "Cordaje de repuesto para raquetas técnicas", "../img/products/cordajeRaqueta.jpg"));
        productoss.add(new Producto("TE03013", "Paletero", "Tenis", 123, 20.39, crearImagen("paleteroTenis"), "Mochila de gran tamaño para almacenar raquetas y bebidas", "../img/products/paleteroTenis.jpg"));
        productoss.add(new Producto("TE03014", "Antivibrador", "Tenis", 435, 3.99, crearImagen("antivibradorRaqueta"), "Pedazo de goma para evitar que la raqueta vibre al golpear la pelota con la raqueta", "../img/products/antivibradorRaqueta.jpg"));
        productoss.add(new Producto("TE03015", "Mochila", "Tenis", 618, 20.99, crearImagen("mochilaTenis"), "Mochila tamaño mediano para almacenar material deportivo", "../img/products/mochilaTenis.jpg"));

        // running
        productoss.add(new Producto("RU04011", "Cronómetro", "Running", 548, 10.49, crearImagen("cronometroRunning"), "Cronometro de calidad, alta precisión", "../img/products/cronometroRunning.jpg"));
        productoss.add(new Producto("RU04012", "Malla corta", "Running", 994, 6.99, crearImagen("mallaCortaRunning"), "Mallas unisex para deportes de running", "../img/products/mallaCortaRunning.jpg"));
        productoss.add(new Producto("RU04013", "Zapatillas", "Running", 238, 49.99, crearImagen("zapatillasRunning"), "Zapatillas de calidad, buena suel y amortiguación en la suela", "../img/products/zapatillasRunning.jpg"));
        productoss.add(new Producto("RU04014", "Auriculares", "Running", 45, 25.49, crearImagen("auricularesRunning"), "Auriculares bluetooth, gran calidad y sonido estereo", "../img/products/auricularesRunning.jpg"));
        productoss.add(new Producto("RU04015", "Pulsera fit", "Running", 761, 13.49, crearImagen("pulseraFit"), "Pulsera deportiva que mide el rítmo cardíaco, los pasos diarios y gráficos semanales", "../img/products/pulseraFit.jpg"));

        // beisbol
        productoss.add(new Producto("BE050011", "Bate aluminio", "Beisbol", 667, 10.49, crearImagen("bateBeisbolAluminio"), "Bate de béisbol de aluminio Gran calidad y resistencia", "../img/products/bateBeisbolAluminio.jpg"));
        productoss.add(new Producto("BE050012", "Casco protector", "Beisbol", 345, 6.99, crearImagen("cascoBeisbol"), "Casco protector muy resistente. Incluye protección bucal", "../img/products/cascoBeisbol.jpg"));
        productoss.add(new Producto("BE050013", "Muñequeras", "Beisbol", 276, 49.99, crearImagen("muñequerasDeporte"), "Muñequeras para limpiarse el sudor", "../img/products/muñequerasDeporte.jpg"));
    ...
    public void cargaProductos(File archivo) {
        ...
        try {
            ...
            for (int i = 0; i < empaquetador.getProductos().size(); i++) {
                ...
                productoss.add(new Producto(empaquetador.getProductos().get(i).getCodigo(),
